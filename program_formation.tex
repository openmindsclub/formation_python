...
01101100001100110011000111101011101
    ...
    \subsection{Les logiciels nécessaires pour la programmation}
        ...
        \subsubsection{Installer Python et PyCharm sous Linux}
            Python est installé par défaut dans toute les distributions Linux. Par contre, il faut installer 
            l'IDE PyCharm, pour cela, il suffit d'ouvrir un terminal (Ctrl+alt+t) et exécuter ces commandes :
